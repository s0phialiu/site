function About() {
    ...
    <div className="!mt-10">
        ...
        <p>
        I have a passion for systems programming and cybersecurity, and I enjoy working on projects that challenge me to learn and grow in these fields. In my free time, I enjoy painting and taking landscape/wildlife photography. 
        </p>
